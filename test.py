...
class CalcView(ui.View):
    def __init__(self, *args, **kwargs):
        ...
        button_style = {'background_color': (0, 0, 0, 0.05), 'tint_color': 'black', 'font': ('HelveticaNeue-Light', 24),
                        'corner_radius': 3}
        ...
        self.display_label = ui.Label(frame=self.display_view.bounds.inset(0, 8), flex='wh', text='0',
