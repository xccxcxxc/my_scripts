...
while True:
    ...
    if len(comicElem) == 0:
        ...
        #time.sleep(5)
        pyautogui.click(740, 495, duration=0.25)
        #pyautogui.moveTo(740, 495, duration=0.25)
        #time.sleep(5)
        time.sleep(0.5)
        ...
        pyautogui.click(740, 575, duration=0.25)
        #pyautogui.moveTo(740, 575, duration=0.25)
        #time.sleep(5)
